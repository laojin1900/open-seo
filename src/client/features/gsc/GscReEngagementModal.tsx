    ...
    >
      <div className="space-y-1">
        <h2 id="gsc-nudge-title" className="text-lg font-semibold">
          {t("New: Connect Google Search Console")}</h2>
        <p className="text-sm text-base-content/70">
          {t("Bring your real clicks, impressions, and rankings into OpenSEO and\n          query them from Claude or Codex over MCP. It never uses credits.")}</p>
      </div>
