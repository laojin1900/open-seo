    ...
    <div className="h-full overflow-auto bg-base-100 px-4 py-8 pb-24 md:px-6 md:py-12 md:pb-8">
      <div className="mx-auto max-w-xl">
        ...
        <h1 className="mt-1 text-2xl font-bold tracking-tight">
          {t("We want to hear from you")}</h1>
        <p className="mt-2 text-sm text-base-content/60">
          {t("We want to talk to you! We're super open to feedback and want to learn\n          how you work so we can make OpenSEO better.")}</p>

        <div className="mt-8 space-y-3">
          <div className="rounded-lg border border-base-300 px-5 py-4">
            <p className="text-sm font-semibold">{t("Email")}</p>
            <p className="mt-1 text-sm text-base-content/60">
              {t("Send ideas, problems, questions, or feedback directly.")}</p>
            <button
              type="button"
              onClick={handleCopy}
          ...
          >
            <p className="text-sm font-semibold">{t("Discord")}</p>
            <p className="mt-1 text-sm text-base-content/60">
              {t("Ask for help, share ideas and learn from the community.")}</p>
            <span className="mt-3 inline-flex items-center gap-1.5 text-sm font-medium text-base-content">
              {t("Join the Discord")}<span aria-hidden="true">&rarr;</span>
            </span>
          </a>
          ...
          <a
            ...
            className="block rounded-lg border border-base-300 px-5 py-4 transition-colors hover:border-base-content/20"
          >
            <p className="text-sm font-semibold">{t("GitHub Issues")}</p>
            <p className="mt-1 text-sm text-base-content/60">
              {t("Report bugs or request features on GitHub.")}</p>
            <span className="mt-3 inline-flex items-center gap-1.5 text-sm font-medium text-base-content">
              {t("Open an issue")}<span aria-hidden="true">&rarr;</span>
            </span>
          </a>
        </div>
      </div>
